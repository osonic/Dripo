M:SMBus
F:G$SMBus_Write_Byte$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$SMBus_Read_Byte$0$0({2}DF,SC:S),Z,0,0,0,0,0
F:G$SMBus_ISR$0$0({2}DF,SV:S),C,0,0,1,6,0
F:G$SMBus_ISR$0$0({2}DF,SV:S),C,0,0,1,6,0
T:FSMBus$UU32[({0}S:S$U32$0$0({4}SL:U),Z,0,0)({0}S:S$S32$0$0({4}SL:S),Z,0,0)({0}S:S$UU16$0$0({4}DA2d,STUU16:S),Z,0,0)({0}S:S$U16$0$0({4}DA2d,SI:U),Z,0,0)({0}S:S$S16$0$0({4}DA2d,SI:S),Z,0,0)({0}S:S$U8$0$0({4}DA4d,SC:U),Z,0,0)({0}S:S$S8$0$0({4}DA4d,SC:S),Z,0,0)]
T:FSMBus$UU16[({0}S:S$U16$0$0({2}SI:U),Z,0,0)({0}S:S$S16$0$0({2}SI:S),Z,0,0)({0}S:S$U8$0$0({2}DA2d,SC:U),Z,0,0)({0}S:S$S8$0$0({2}DA2d,SC:S),Z,0,0)]
S:G$SMB_DATA_IN$0$0({1}SC:U),E,0,0
S:G$SMB_DATA_OUT$0$0({1}SC:U),E,0,0
S:G$TARGET$0$0({1}SC:U),E,0,0
S:G$SMB_BUSY$0$0({1}SB0$1:U),H,0,0
S:G$SMB_RW$0$0({1}SB0$1:U),H,0,0
S:LSMBus.SMBus_ISR$ADDR_SEND$1$22({1}SB0$1:U),H,0,0
...
S:G$SMBus_ISR$0$0({2}DF,SV:S),C,0,0
S:FSMBus$_str_0$0$0({7}DA7d,SC:S),D,0,0
